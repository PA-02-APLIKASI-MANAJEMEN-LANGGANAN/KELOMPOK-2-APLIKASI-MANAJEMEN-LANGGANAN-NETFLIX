...
def login():
    try:
        ...
        while kesempatan > 0:
            ...
            kesempatan -= 1
            print(Fore.RED+"Username atau password salah. Sisa kesempatan: {kesempatan}")
...
def ubah_langganan():
    try:
        ...
        if nama_baru and nama_baru != detail["nama"]:
            ...
            ada_perubahan = True
        elif harga_baru is not None and harga_baru != detail["harga"]:
            langganan_netflix[id_ubah]["harga"] = harga_baru
            ada_perubahan = True
        elif kualitas_baru and kualitas_baru != detail["kualitas"]:
            langganan_netflix[id_ubah]["kualitas"] = kualitas_baru
            ada_perubahan = True
        elif jumlah_device_baru is not None and jumlah_device_baru != detail["jumlah_device"]:
